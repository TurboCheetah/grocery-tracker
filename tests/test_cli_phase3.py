...
class TestPreferencesView:
    ...
    def test_view_no_prefs(self, _setup_cli):
        ...
        result = runner.invoke(app, ["--json", "preferences", "view", "Francisco"])
        assert result.exit_code == 0  # warns, doesn't fail
    ...
    def test_view_with_prefs(self, _setup_cli):
        ...
        runner.invoke(
            app,
            ["--json", "preferences", "set", "Francisco", "--favorite", "mango"],
        )
        result = runner.invoke(
            app, ["--json", "preferences", "view", "Francisco"]
        )
        assert result.exit_code == 0
        output = json.loads(result.stdout)
    ...
    def test_view_rich_mode(self, _setup_cli):
        ...
        runner.invoke(
            app,
            ["preferences", "set", "Francisco", "--favorite", "mango"],
        )
        result = runner.invoke(app, ["preferences", "view", "Francisco"])
        assert result.exit_code == 0
...
class TestPreferencesSet:
    ...
    def test_set_brand(self, _setup_cli):
        ...
        result = runner.invoke(
            app,
            ["--json", "preferences", "set", "Francisco", "--brand", "milk:Organic Valley"],
        )
        assert result.exit_code == 0
        output = json.loads(result.stdout)
    ...
    def test_set_dietary(self, _setup_cli):
        ...
        result = runner.invoke(
            app,
            ["--json", "preferences", "set", "Loki", "--dietary", "vegetarian"],
        )
        assert result.exit_code == 0
        output = json.loads(result.stdout)
    ...
    def test_set_allergen(self, _setup_cli):
        ...
        result = runner.invoke(
            app,
            ["--json", "preferences", "set", "Francisco", "--allergen", "peanuts"],
        )
        assert result.exit_code == 0
        output = json.loads(result.stdout)
    ...
    def test_set_multiple(self, _setup_cli):
        ...
        result = runner.invoke(
            app,
            [
                "--json", "preferences", "set", "Francisco",
                "--favorite", "mango",
    ...
    def test_set_updates_existing(self, _setup_cli):
        ...
        runner.invoke(
            app,
            ["--json", "preferences", "set", "Francisco", "--dietary", "vegetarian"],
        )
