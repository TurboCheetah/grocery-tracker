...
Francisco and Loki share the grocery list. Consider:
- Brand preferences differ (Francisco: Organic Valley, Loki: Horizon)
...
```
Note: Loki prefers Horizon Organic for milk
Note: Francisco usually shops on Saturdays
```
